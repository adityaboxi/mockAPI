...
// ============================================================
// INSTRUCTIONS:
// 1. Copy this file to the ROOT of EVERY Node.js service.
// 2. Add this ONE LINE to your main entry file (at the VERY TOP):
//    require('./universal-logger');
// 3. Set env vars on EC2:
//    - NODE_ENV=production  (saves disk space)
//    - LOG_SERVER_URL=http://telemetry-server:3003/v1/logs
//    - CONTAINER_NAME=server-1 (optional)
// ============================================================
