...
const QueryParamsSection = React.memo(({
  ...
  const emptyState = queryParams.length === 0 && !showQueryParamInput;
          ...
          <div className="flex flex-col gap-1.5 mb-2">
            {queryParams.map((param, idx) => (
              <div key={param.key || idx} className="flex items-center gap-2">
                <span className={`w-1/3 rounded px-2 py-1 text-xs font-mono ${
          ...
          <div className="flex flex-col gap-2 mt-1">
            ...
            <div className="flex gap-1.5">
              ...
              <button
                ...
                className={`px-2 py-1 rounded text-xs ${miniBtn}`}
              >
                Cancel
              </button>
            </div>
