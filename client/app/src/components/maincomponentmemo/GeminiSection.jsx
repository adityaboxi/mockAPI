    ...
    <div className={`border-t ${w ? "border-gray-200 bg-white" : "border-zinc-700/50 bg-[#1e1f22]"}`}>
      <div className={`flex items-center justify-between px-3 py-2 border-b text-xs ${
        ...
        <div className="flex gap-2">
          <button className="bg-blue-600 hover:bg-blue-500 text-white px-3 py-0.5 rounded text-xs font-medium transition-colors">
            Update
          </button>
          <button className="bg-blue-600 hover:bg-blue-500 text-white px-3 py-0.5 rounded text-xs font-medium transition-colors">
            New API
      ...
      <div className="relative">
        <textarea
          ...
          rows={4}
          className={`w-full px-3 pt-3 pb-8 resize-y outline-none text-sm ${
            w ? "bg-white text-gray-800 placeholder-gray-400" : "bg-[#1e1f22] text-gray-300 placeholder-zinc-600"
          }`}
          placeholder="Ask Gemini for API URL and request/response structure..."
          spellCheck="false"
        />
        <button className="absolute bottom-2.5 right-2.5 px-3 py-1 bg-blue-600 hover:bg-blue-500 text-white rounded text-xs font-medium transition-colors">
          Ask AI ✦
        </button>
      </div>
    </div>
