  ...
  return (
    <div className={`min-h-screen flex items-center justify-center py-8 px-4 ${
      ...
      <div className={`p-8 rounded shadow-lg border w-full max-w-sm ${
        ...
        <div className="mb-4">
          <h1 className={`text-xs font-medium mb-1 ${isWhiteTheme ? "text-gray-500" : "text-zinc-400"}`}>name:</h1>
          <input
        ...
        <div className="mb-4">
          <h1 className={`text-xs font-medium mb-1 ${isWhiteTheme ? "text-gray-500" : "text-zinc-400"}`}>emailid:</h1>
          <input
        ...
        <div className="mb-4">
          <h1 className={`text-xs font-medium mb-1 ${isWhiteTheme ? "text-gray-500" : "text-zinc-400"}`}>username:</h1>
          <input
        ...
        <div className="mb-4">
          <h1 className={`text-xs font-medium mb-1 ${isWhiteTheme ? "text-gray-500" : "text-zinc-400"}`}>new password:</h1>
          <input
        ...
        <div className="mb-4">
          <h1 className={`text-xs font-medium mb-1 ${isWhiteTheme ? "text-gray-500" : "text-zinc-400"}`}>confirm password:</h1>
          <input
